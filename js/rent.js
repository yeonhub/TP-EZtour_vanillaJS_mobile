...
function rent() {
    ...
    let $R_visPerPoNaNvw = get('.rentVis .inner .search .popPer .xi-close')
    ...
    let $R_visInsuPoNaNvw = get('.rentVis .inner .search .popInsu .xi-close')
    ...
    let $R_nextBtn = get('.rentVis .inner .search .popDateBox .popDate .popDateS .next')
    let $R_prevBtnR = get('.rentVis .inner .search .popDateBoxR .popDate .popDateS .prev')
    let $R_nextBtnR = get('.rentVis .inner .search .popDateBoxR .popDate .popDateS .next')
    ...
    vehicles.forEach(ele => {
        ...
        li.innerHTML =
          ...
          <div class="price">
          <a href="">
          <p><i class="xi-shield-checked-o"></i>일반자차 <em></em><span>${ele.price1.toLocaleString()}원 부터</span></p></a>
          <a href=""><p><i class="xi-shield-checked-o"></i>완전자차 <em></em><span>${ele.price2.toLocaleString()}원 부터</span></p></a>
          <a href=""><p><i class="xi-shield-checked-o"></i>슈퍼자차 <em></em><span>${ele.price3.toLocaleString()}원 부터</span></p></a>
          </div>
          `;
    ...
    $R_type.forEach(item => {
        item.addEventListener('click', e => {
            ...
            item.style.borderRadius = '2.7778vw';
        });
    });
    ...
    function R_select(day, calendarType) {
        ...
        if (calendarType === 'popDateS') {
            ...
            $R_visDateS.innerHTML = `${dateForm}   ${$R_visTimeS.value}`;
    ...
    function R_selectR(day, calendarType) {
        ...
        if (calendarType === 'popDateS') {
            ...
            $R_visDateR.innerHTML = `${dateForm}   ${$R_visTimeE.value}`;
    ...
    $R_visDateS.addEventListener('click', e => {
        ...
        $R_visDateSBox.style.height = '152.7778vw';
        $R_visDateSBox1.style.top = 0;
        $R_visDateSBox1.style.boxShadow = '0.0000vw 0.0000vw 2.7778vw';
        R_calendar();
        // 
        R_visInsuClose();
        R_visDateRClose();
    ...
    $R_visDateR.addEventListener('click', e => {
        ...
        $R_visDateRBox.style.height = '152.7778vw';
        $R_visDateBox1R.style.top = 0;
        $R_visDateBox1R.style.boxShadow = '0.0000vw 0.0000vw 2.7778vw';
        R_calendarR();
        // 
        R_visDateSClose()
        R_visInsuClose();
    ...
    $R_visInsu.addEventListener('click', e => {
        ...
        $R_visInsuPopBox.style.height = '47.2222vw';
        $R_visInsuPop.style.top = 0;
        $R_visInsuPop.style.boxShadow = '0.0000vw 0.0000vw 2.7778vw';
        //
        R_visDateSClose()
        R_visDateRClose()
    })
    $R_visInsuPoNaNvw.addEventListener('click', e => {
        R_visInsuClose();
    })
